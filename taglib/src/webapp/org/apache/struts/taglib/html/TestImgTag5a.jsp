...
<logic:equal name="runTest" value="testImgSrcNameNoScope">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <img src="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null,"/some/image.gif",  null, null, null, thisMap1, null, false)%>">
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testImgSrcNamePropertyNoScope">
    ...
    <bean:define id="thisMap2" name="paramPropertyMapNoScope" property="map"
                 type="java.util.Map"/>
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <img src="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/image.gif", null, null, null, thisMap2, null, false)%>">
    </bean:define>
</logic:equal>
