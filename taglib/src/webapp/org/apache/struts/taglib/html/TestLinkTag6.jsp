...
<logic:equal name="runTest" value="testLinkHrefOnclick">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" onclick="onclick">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefOndblclick">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" ondblclick="ondblclick">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefOnfocus">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" onfocus="onfocus">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefOnkeydown">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" onkeydown="onkeydown">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefOnkeypress">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" onkeypress="onkeypress">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefOnkeyup">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" onkeyup="onkeyup">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefOnmouseout">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" onmouseout="onmouseout">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefOnmouseup">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" onmouseup="onmouseup">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefParamIdParamNameNoScope">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>?myParam=paramValue">Test
            Link</a>
    </bean:define>
</logic:equal>

<logic:equal name="runTest"
             value="testLinkHrefParamIdParamNameParamPropertyNoScope">
    <bean:define id="TEST_RESULTS" toScope="page">
        <html:link href="/some/page.do" paramId="myParam"
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>?myParam=paramPropertyValue">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest"
             value="testLinkHrefParamIdParamNameApplicationScope">
    <bean:define id="TEST_RESULTS" toScope="page">
        <html:link href="/some/page.do" paramId="myParam"
                   paramName="paramName">Test Link</html:link>
    </bean:define>
...
<logic:equal name="runTest" value="testLinkHrefTransaction">
    <bean:define id="TEST_RESULTS" toScope="page">
        <html:link href="/some/page.do" transaction="true">Test
            Link</html:link>
    </bean:define>
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>?org.apache.struts.taglib.html.TOKEN=Some_Token_Here">Test
            Link</a>
    </bean:define>
</logic:equal>
