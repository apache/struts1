...
<logic:equal name="runTest"
             value="testFramePageParamIdParamNameParamPropertyNoScope">
    <bean:define id="TEST_RESULTS" toScope="page">
        <html:frame page="/path/to/non/existing/jsp.jsp" paramId="myParam"
...
<logic:equal name="runTest"
             value="testFramePageParamIdParamNameApplicationScope">
    <bean:define id="TEST_RESULTS" toScope="page">
        <html:frame page="/path/to/non/existing/jsp.jsp" paramId="myParam"
                    paramName="paramName"/>
    </bean:define>
...
<logic:equal name="runTest"
             value="testFramePageParamIdParamNameParamPropertyApplicationScope">
    <bean:define id="TEST_RESULTS" toScope="page">
        <html:frame page="/path/to/non/existing/jsp.jsp" paramId="myParam"
                    paramName="testingParamProperty" paramProperty="string"/>
    </bean:define>
...
<logic:equal name="runTest"
             value="testFramePageParamIdParamNameParamPropertySessionScope">
    <bean:define id="TEST_RESULTS" toScope="page">
        <html:frame page="/path/to/non/existing/jsp.jsp" paramId="myParam"
                    paramName="testingParamProperty" paramProperty="string"/>
    </bean:define>
...
<logic:equal name="runTest"
             value="testFramePageParamIdParamNameParamPropertyRequestScope">
    <bean:define id="TEST_RESULTS" toScope="page">
        <html:frame page="/path/to/non/existing/jsp.jsp" paramId="myParam"
                    paramName="testingParamProperty" paramProperty="string"/>
    </bean:define>
