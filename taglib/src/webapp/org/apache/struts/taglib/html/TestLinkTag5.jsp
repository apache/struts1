...
<logic:equal name="runTest" value="testLinkHref">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefAccesskey">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, null, false)%>"
...
<logic:equal name="runTest" value="testLinkHrefAnchor">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do#XXX", null, null, null, null, null, false)%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefIndexedArray">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst">
            <html:link href="/some/page.do" indexed="true">Test
                Link</html:link>
        </logic:iterate>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">

        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do?index=0", null, null, null, null, null, false)%>">Test
            Link</a>
...
<logic:equal name="runTest" value="testLinkHrefIndexedEnumeration">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        ...
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do?index=1", null, null, null, null, null, false)%>">Test
            Link</a>
...
<logic:equal name="runTest" value="testLinkHrefIndexedAlternateIdArray">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        ...
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do?alternateId=0", null, null, null, null, null, false)%>">Test
            Link</a>
...
<logic:equal name="runTest"
             value="testLinkHrefIndexedAlternateIdArrayProperty">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst" property="list">
            <html:link href="/some/page.do" indexed="true"
                       indexId="alternateId">Test Link</html:link>
...
<logic:equal name="runTest" value="testLinkHrefIndexedAlternateIdEnumeration">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        ...
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do?alternateId=1", null, null, null, null, null, false)%>">Test
            Link</a>
...
<logic:equal name="runTest" value="testLinkHrefNameNoScope">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, thisMap, null, false)%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefNamePropertyNoScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" name="paramPropertyMap"
...
<logic:equal name="runTest" value="testLinkHrefNameApplicationScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link href="/some/page.do" name="paramMap" scope="application">
            Test Link</html:link>
    </bean:define>
    <bean:define id="thisMap" name="paramMap" type="java.util.Map"/>
    <bean:define id="TEST_RESULTS" toScope="page">
