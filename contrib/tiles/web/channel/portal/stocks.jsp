...
<TABLE border=0 cellPadding=2 cellSpacing=0 width=190>
  ...
  <TR>
    <TD class=datagrey colSpan=3><IMG height=1 src="<%=request.getContextPath()%>/images/id_line.gif" 
      width=190></TD></TR>
  <TR>
  ...
  <TR>
    <TD class=inputgrey colSpan=3>
      ...
      border=0 height=17 src="<%=request.getContextPath()%>/images/input_vrm_gen_get.gif" title="Get Quote" 
      width=59></A> <BR>&nbsp; <BR>
