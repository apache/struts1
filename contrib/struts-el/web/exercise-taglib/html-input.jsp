 ...
 <body bgcolor="white">
  ...
  <html-el:form action="html-input.do">
   <table>
    <tr>
     <td>
      <html-el:hidden property="stringProperty" write="${!empty pageScope}"/>
     </td>
    </tr>
    <tr>
     <td>
    ...
    <tr>
     <td>
      <html-el:hidden property="stringProperty" title="${thing}"/>
     </td>
    </tr>
    <tr>
     <td>
      <logic-el:iterate collection="${pageScope}" id="item">
       <html-el:hidden property="stringProperty" indexed="${!empty pageScope}"/>
      </logic-el:iterate>
     </td>
    </tr>
    <tr>
     <td>
      <logic-el:iterate collection="${pageScope}" id="item">
       <html-el:hidden name="testbean" property="stringProperty" indexed="${!empty pageScope}"/>
      </logic-el:iterate>
     </td>
    </tr>
    <tr>
     <td>
      <html-el:password property="stringProperty" title="${thing}"/>
     </td>
    </tr>
    <tr>
     <td>
