...
<template:insert template='/WEB-INF/templates/mainTemplate.jsp'>
  <template:put name='title'>
     <bean:message key="registrationForm.title.search"/>
  </template:put>
        ...
        <logic:iterate id="searchResults" name="<%= com.wintecinc.struts.action.GenericAction.SEARCH_KEY %>">
           <tr bgcolor="#ffffff">
               ...
               <td align=center nowrap><font size=-1>
                  <A href="registration.do?action=edit&id=<bean:write name="searchResults" property="id"/>">
                     <bean:message key="button.edit"/>
                  </A>
                  </font>
               </td>
               <td align=center nowrap><font size=-1>
                  <A href="registration.do?action=delete&id=<bean:write name="searchResults" property="id"/>">
