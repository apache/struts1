...
<template:insert template='/WEB-INF/templates/mainTemplate.jsp'>
  <template:put name='title'>
     <bean:message key="multiRegistrationForm.title.search"/>
  </template:put>
  ...
  <template:put name='main'>
     <font size=+2><bean:message key="multiRegistrationForm.title.search"/></font><BR><BR>
     ...
     <html:form action="multiRegistration">
        ...
        <logic:iterate id="searchResults" name="<%= com.wintecinc.struts.action.GenericAction.SEARCH_KEY %>">
           <tr bgcolor="#ffffff">
               ...
               <td align=center nowrap><font size=-1>
                  <A href="multiRegistration.do?action=edit&id=<bean:write name="searchResults" property="id"/>">
                     <bean:message key="button.edit"/>
                  </A>
                  </font>
               </td>
               <td align=center nowrap><font size=-1>
                  <A href="multiRegistration.do?action=delete&id=<bean:write name="searchResults" property="id"/>">
