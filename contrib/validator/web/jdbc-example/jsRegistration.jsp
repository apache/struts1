...
<template:insert template='/WEB-INF/templates/mainTemplate.jsp'>
  <template:put name='title'>
     <bean:message key="jsRegistrationForm.title"/>
  </template:put>
  ...
  <template:put name='main'>
      ...
      <html:form action="jsRegistration" onsubmit="return validateJsRegistrationForm(this);">
      ...
      <%-- Buttons --%>
      <tr><td nowrap>
      <logic:notEqual name="jsRegistrationForm" property="action" value="delete">
      ...
      <logic:equal name="jsRegistrationForm" property="action" value="delete">
      ...
      <logic:notEqual name="jsRegistrationForm" property="action" value="delete">
         <validator:javascript formName="jsRegistrationForm"/>
      </logic:notEqual>
  </template:put>  
