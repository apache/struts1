...
/**
 * Suite of unit tests for the <code>org.apache.struts.taglib.logic.LessEqualTag</code>
 * class.
 */
public class TestLessEqualTag extends JspTestCase {
    ...
    public static void main(String[] theArgs) {
        junit.awtui.TestRunner
                .main(new String[] { TestLessEqualTag.class.getName() });
    }
    ...
    public void testCookieLessEqual() throws ServletException, JspException {
        ...
        assertTrue(
                "Cookie Value (" + GREATER_VAL
                        + ") is less than or equal to value (" + LESSER_VAL
                        + ")",
                ge.condition());
    }
     ...
     */
    public void testParameterLessEqual()
    ...
    /**
     * Testing <code>LessEqualTag</code> using name attribute in the
     * application scope.
     */
    ...
    /**
     * Testing <code>LessEqualTag</code> using name attribute in the session
     * scope.
     */
    ...
    /**
     * Testing <code>LessEqualTag</code> using name attribute in the request
     * scope.
     */
