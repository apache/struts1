...
<logic:equal name="runTest" value="testLinkForward">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=response.encodeURL( request.getContextPath() + "/path/to/non/existing/jsp.jsp")%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkForwardAccesskey">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link forward="simpleForward" accesskey="XXX">Test
            Link</html:link>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">
...
<logic:equal name="runTest" value="testLinkForwardAnchor">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=response.encodeURL( request.getContextPath() + "/path/to/non/existing/jsp.jsp#XXX")%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkForwardIndexedArray">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst">
            <html:link forward="simpleForward" indexed="true">Test
                Link</html:link>
        </logic:iterate>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">

        <a href="<%=response.encodeURL( request.getContextPath() + "/path/to/non/existing/jsp.jsp?index=0")%>">Test
            Link</a>
...
<logic:equal name="runTest" value="testLinkForwardIndexedEnumeration">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        ...
        <a href="<%=response.encodeURL( request.getContextPath() + "/path/to/non/existing/jsp.jsp?index=1")%>">Test
            Link</a>
...
<logic:equal name="runTest" value="testLinkForwardIndexedAlternateIdArray">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst">
            <html:link forward="simpleForward" indexed="true"
                       indexId="alternateId">Test Link</html:link>
        </logic:iterate>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">

        <a href="<%=response.encodeURL( request.getContextPath() + "/path/to/non/existing/jsp.jsp?alternateId=0")%>">Test
            Link</a>
...
<logic:equal name="runTest"
             value="testLinkForwardIndexedAlternateIdArrayProperty">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst" property="list">
            <html:link forward="simpleForward" indexed="true"
                       indexId="alternateId">Test Link</html:link>
...
<logic:equal name="runTest"
             value="testLinkForwardIndexedAlternateIdMapProperty">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst" property="map">
            <html:link forward="simpleForward" indexed="true"
                       indexId="alternateId">Test Link</html:link>
...
<logic:equal name="runTest"
             value="testLinkForwardIndexedAlternateIdEnumeration">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst">
            <html:link forward="simpleForward" indexed="true"
                       indexId="alternateId">Test Link</html:link>
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        ...
        <a href="<%=response.encodeURL( request.getContextPath() + "/path/to/non/existing/jsp.jsp?alternateId=1")%>">Test
            Link</a>
...
<logic:equal name="runTest"
             value="testLinkForwardIndexedAlternateIdEnumerationProperty">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst" property="enumeration">
            <html:link forward="simpleForward" indexed="true"
                       indexId="alternateId">Test Link</html:link>
...
<logic:equal name="runTest" value="testLinkForwardNameNoScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link forward="simpleForward" name="paramMap">Test
            Link</html:link>
    </bean:define>
    <bean:define id="thisMap" name="paramMap" type="java.util.Map"/>
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, "simpleForward", null, null, null, null, thisMap, null, false)%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkForwardNamePropertyNoScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link forward="simpleForward" name="paramPropertyMap"
...
<logic:equal name="runTest" value="testLinkForwardNameApplicationScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link forward="simpleForward" name="paramMap"
...
<logic:equal name="runTest"
             value="testLinkForwardNamePropertyApplicationScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link forward="simpleForward" name="paramPropertyMap"
...
<logic:equal name="runTest" value="testLinkForwardNameSessionScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link forward="simpleForward" name="paramMap" scope="session">
            Test Link</html:link>
    </bean:define>
    <bean:define id="thisMap" name="paramMap" type="java.util.Map"/>
    <bean:define id="TEST_RESULTS" toScope="page">
...
<logic:equal name="runTest" value="testLinkForwardNameRequestScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link forward="simpleForward" name="paramMap" scope="request">
            Test Link</html:link>
    </bean:define>
    <bean:define id="thisMap" name="paramMap" type="java.util.Map"/>
    <bean:define id="TEST_RESULTS" toScope="page">
