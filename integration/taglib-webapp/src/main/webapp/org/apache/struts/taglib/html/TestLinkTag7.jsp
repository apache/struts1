...
<logic:equal name="runTest" value="testLinkPage">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/some/page.do", null, null, null, null, false)%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkPageAnchor">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/some/page.do#XXX", null, null, null, null, false)%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkPageIndexedArray">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst">
            <html:link page="/some/page.do" indexed="true">Test
                Link</html:link>
        </logic:iterate>
    </bean:define>
    <bean:define id="TEST_RESULTS" toScope="page">

        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/some/page.do?index=0", null, null, null, null, false)%>">Test
            Link</a>
...
<logic:equal name="runTest" value="testLinkPageIndexedEnumeration">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        ...
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/some/page.do?index=1", null, null, null, null, false)%>">Test
            Link</a>
...
<logic:equal name="runTest" value="testLinkPageIndexedAlternateIdArray">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        ...
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/some/page.do?alternateId=0", null, null, null, null, false)%>">Test
            Link</a>
...
<logic:equal name="runTest"
             value="testLinkPageIndexedAlternateIdArrayProperty">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <logic:iterate id="indivItem" name="lst" property="list">
            <html:link page="/some/page.do" indexed="true"
                       indexId="alternateId">Test Link</html:link>
...
<logic:equal name="runTest" value="testLinkPageIndexedAlternateIdEnumeration">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        ...
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/some/page.do?alternateId=1", null, null, null, null, false)%>">Test
            Link</a>
...
<logic:equal name="runTest" value="testLinkPageNameNoScope">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/some/page.do", null, null, thisMap, null, false)%>">Test
            Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkPageNamePropertyNoScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link page="/some/page.do" name="paramPropertyMap"
...
<logic:equal name="runTest" value="testLinkPageNameApplicationScope">
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <html:link page="/some/page.do" name="paramMap" scope="application">
            Test Link</html:link>
    </bean:define>
    <bean:define id="thisMap" name="paramMap" type="java.util.Map"/>
    <bean:define id="TEST_RESULTS" toScope="page">
