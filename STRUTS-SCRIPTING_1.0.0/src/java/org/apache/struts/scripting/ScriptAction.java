 ...
 *
 *  <ul>
 *    <li> <code>struts-scripting.engine.ENGINE_NAME.class</code> - The class of the
...
public class ScriptAction extends Action {
    ...
    static {
        ...
        try {
            ...
            if (in == null) {
                ...
                if (in != null) {
                    log.warn("The struts-bsf.properties file has been deprecated.  Please use "+
        ...
        for (Enumeration e = props.propertyNames(); e.hasMoreElements(); ) {
            ...
            if (name.startsWith(ENGINE_BASE) && name.endsWith(".class")) {
                ...
                if (log.isInfoEnabled()) {
                    log.info("Loading BSF engine name:" + type + " class:" + cls + " ext:" + ext);
                }
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        StrutsInfo struts = new StrutsInfo(this, mapping, form, getResources(request));
        ...
        if (url != null) {
            ...
            if (parsed.length == 2) {
                ...
                for (int x = 0; x < args.length; x++) {
                    ...
                    if (o != null) {
                        log.warn("BSF variable " + param[0] + " already exists");
                        param[0] = "_" + param[0];
                    }
                    manager.declareBean(param[0], param[1], String.class);
                    if (log.isDebugEnabled()) {
                        log.debug("Registering param " + param[0] + " with value " + param[1]);
                    }
                }
            } else {
                if (log.isDebugEnabled()) {
