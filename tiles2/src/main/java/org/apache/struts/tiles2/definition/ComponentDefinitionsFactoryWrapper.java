...
package org.apache.struts.tiles2.definition;
...
import org.apache.struts.tiles2.ComponentDefinitionsFactory;
import org.apache.struts.tiles2.DefinitionsFactory;
import org.apache.struts.tiles2.DefinitionsFactoryConfig;
...
public class ComponentDefinitionsFactoryWrapper implements DefinitionsFactory {
    ...
    public static Map createConfigMap(DefinitionsFactoryConfig config) {
        ...
        if (!"org.apache.struts.tiles2.xmlDefinition.I18nFactorySet"
