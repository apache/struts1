...
<logic:equal name="runTest" value="testImgPageKeyNameNoScope">
   ...
   <bean:define id="EXPECTED_RESULTS" toScope="page">
		<img src="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/images/default/default/myimage.gif", null, thisMap1, null, false)%>">
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testImgPageKeyNamePropertyNoScope">
   ...
   <bean:define id="EXPECTED_RESULTS" toScope="page">
		<img src="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, null, "/images/default/default/myimage.gif", null, thisMap2, null, false)%>">
    </bean:define>
</logic:equal>
