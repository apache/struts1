...
<logic:equal name="runTest" value="testLinkHref">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefAccesskey">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" accesskey="XXX">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefAnchor">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do#XXX", null, null, null, null, false)%>">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefIndexedArray">
	...
	<bean:define id="TEST_RESULTS" toScope="page">
		...
		<a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do?index=0", null, null, null, null, false)%>">Test Link</a>
...
<logic:equal name="runTest" value="testLinkHrefIndexedEnumeration">
	...
	<bean:define id="TEST_RESULTS" toScope="page">
		...
		<a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do?index=1", null, null, null, null, false)%>">Test Link</a>
...
<logic:equal name="runTest" value="testLinkHrefIndexedAlternateIdArray">
	...
	<bean:define id="TEST_RESULTS" toScope="page">
		...
		<a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do?alternateId=0", null, null, null, null, false)%>">Test Link</a>
...
<logic:equal name="runTest" value="testLinkHrefIndexedAlternateIdEnumeration">
	...
	<bean:define id="TEST_RESULTS" toScope="page">
		...
		<a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do?alternateId=1", null, null, null, null, false)%>">Test Link</a>
...
<logic:equal name="runTest" value="testLinkHrefNameNoScope">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
		<a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, thisMap, null, false)%>">Test Link</a>
    </bean:define>
</logic:equal>
