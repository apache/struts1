...
<logic:equal name="runTest" value="testImgSrcNameNoScope">
   ...
   <bean:define id="EXPECTED_RESULTS" toScope="page">
		<img src="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null,"/some/image.gif",  null, null, thisMap1, null, false)%>">
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testImgSrcNamePropertyNoScope">
   ...
   <bean:define id="EXPECTED_RESULTS" toScope="page">
		<img src="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/image.gif", null, null, thisMap2, null, false)%>">
    </bean:define>
</logic:equal>
