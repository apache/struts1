...
<logic:equal name="runTest" value="testLinkHrefOnblur">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onblur="onblur">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnclick">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onclick="onclick">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOndblclick">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" ondblclick="ondblclick">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnfocus">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onfocus="onfocus">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnkeydown">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onkeydown="onkeydown">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnkeypress">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onkeypress="onkeypress">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnkeyup">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onkeyup="onkeyup">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnmousedown">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onmousedown="onmousedown">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnmousemove">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onmousemove="onmousemove">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnmouseout">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onmouseout="onmouseout">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnmouseover">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onmouseover="onmouseover">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefOnmouseup">
    ...
    <bean:define id="TEST_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" onmouseup="onmouseup">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefParamIdParamNameNoScope">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
		<a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>?myParam=paramValue">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefParamIdParamNameParamPropertyNoScope">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
		<a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>?myParam=paramPropertyValue">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefStyle">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" style="XXX">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefStyleClass">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" class="XXX">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefStyleId">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" id="XXX">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefTabIndex">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" tabindex="4">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefTarget">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" target="_new">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefTitle">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" title="XXX">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefTitleKey">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>" title="Testing Message">Test Link</a>
    </bean:define>
</logic:equal>
...
<logic:equal name="runTest" value="testLinkHrefTransaction">
    ...
    <bean:define id="EXPECTED_RESULTS" toScope="page">
        <a href="<%=org.apache.struts.taglib.TagUtils.getInstance().computeURL(pageContext, null, "/some/page.do", null, null, null, null, false)%>?org.apache.struts.taglib.html.TOKEN=Some_Token_Here">Test Link</a>
    </bean:define>
</logic:equal>
